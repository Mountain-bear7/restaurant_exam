    ...
    <section className='min-h-[780px]'>
      ...
      >
        <div className="container mx-auto">
          <div className='lg:-mt-24 min-h-[590px] z-30 mb-8 md:mb-4 xl:-mb-16'>
            <div className='grid grid-cols-1 lg:grid-cols-4 min-h-[590px ]'>
              {menuItems.map((item, index) => {
                ...
                return <div key={index} className='bg-[#fff3e4] h-full'>
                  <div className='flex flex-row lg:flex-col h-full'>
                    ...
                    >
                      <img src={image} alt="menu im age"/>
                    </div>
                    <div className='flex-1 flex flex-col text-center justify-center px-6 lg:p-12 lg:max-h-[250px] xl: max-h-max h-full md:mt-[80px]'>
          ...
          <button className='btn mx-auto mt-20 capitalize cursor-pointer'>{btnText}</button>
        </div>
      </motion.div>
    </section>
  )
